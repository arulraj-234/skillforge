...
export const ACHIEVEMENTS = [
  ...
  { id: "ach-dsa50", title: "Problem Crusher", desc: "Solve 50 DSA problems", icon: "target", condition: (state) => state.dsa.total >= 50 },
  { id: "ach-dsa100", title: "Century Solver", desc: "Solve 100 DSA problems", icon: "award", condition: (state) => state.dsa.total >= 100 },
  { id: "ach-dsa200", title: "DSA Beast", desc: "Solve 200 DSA problems", icon: "trophy", condition: (state) => state.dsa.total >= 200 },
